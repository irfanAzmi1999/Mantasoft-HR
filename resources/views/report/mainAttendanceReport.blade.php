...
@section('content')
    ...
    <div class="content-body">
        <div class="row">
                <form class="form form-horizontal" action="/printAttendance" method="post" enctype="multipart/form-data" target="_blank" rel="noopener noreferrer">
                    @csrf
                            ...
                            <div class="row">
                                    ...
                                    <div class="mb-1 row">
                                        ...
                                        <div id="leave_form" class="col-9 mb-1 mb-sm-0">
                                            @role('admin|director|sysadmin')
                                                <select class="col-sm-3 form-control form-select select2 input-group" name="department" id="department" required>
                                            ...
                                            @role('hod')
                                                ...
                                                <input class="form-control" type="hidden" value="{{ $hodDepartment->getDepartment->id }}" name="department" id="department">
                                            @endrole
                                        </div>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="mb-1 row">
                                        ...
                                        <div id="leave_form" class="col-9 mb-1 mb-sm-0">
                                            <select class="col-sm-3 form-control form-select select2 input-group" name="month" id="month" required>
                                ...
                                <div class="col-12">
                                    <div class="mb-1 row">
                                        ...
                                        <div id="leave_form" class="col-9 mb-1 mb-sm-0">
                                            <select class="col-sm-3 form-control form-select select2 input-group" name="year" id="year" required>
    ...
    @section('extraJS')
        ...
        <script src={{ asset('custom_js/attendancereport.js') }}></script>
    @endsection
