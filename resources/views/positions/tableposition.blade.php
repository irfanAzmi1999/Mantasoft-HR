...
@section('content')
    ...
    <div class="table-title">
        <div class="row">
            ...
            <div class="col-sm-4">
                <button id="newPosition" class="btn btn-info add-new float-end" style="text-decoration: none; color: white;">
