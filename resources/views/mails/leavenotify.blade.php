...
<head>
    ...
    <style type="text/css">
        ...
        @media only screen and (max-width: 550px), screen and (max-device-width: 550px) {
            ...
            body[yahoo] .button a {
                background-color: #effb41; padding: 15px 15px 13px!important;
            }
                ...
                <table bgcolor="#ffffff" class="content" align="center" cellpadding="0" cellspacing="0" border="0">
                    ...
                    <tr>
                        <td class="innerpadding borderbottom">
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                ...
                                <tr>
                                    <td class="bodycopy">
                                        Dear Mr/Mrs. {{ $notify['superior'] }},<br><br>
                                        We would like to inform that Staff {{ $notify['nameStaff'] }}
                                        have applied for a leave and has been <b>{{ $notify['status'] }}</b>.
                                        Hereby the leave details for {{ $notify['nameStaff'] }}:
                                    </td>
                                </tr>
                            </table>
                        </td>
                        ...
                        <td class="innerpadding borderbottom">
                            <table class="col380" align="left" border="0" cellpadding="10" cellspacing="2" style="width: 100%; max-width: 380px;">
                                ...
                                <tr>
                                    <td>Leave Type</td>
                                    <td>:</td>
                                    <td>{{ $notify['leaveType'] }}</td>
                                </tr>
                                <tr>
                                    <td>Leave Start</td>
                                    <td>:</td>
                                    <td>{{ $notify['start_date'] }}</td>
                                </tr>
                                <tr>
                                    <td>Leave End</td>
                                    <td>:</td>
                                    <td>{{ $notify['end_date'] }}</td>
                                </tr>
                                <tr>
                                    <td>Days Taken</td>
                                    <td>:</td>
                                    <td>{{ $notify['date_leave'] }}</td>
                                </tr>
                            </table>
                        </td>
                    </tr>
                    <tr>
                        <td class="innerpadding bodycopy">
                            If you wish to learn more about {{ $notify['nameStaff'] }}'s leave application,
                             kindly go to <a href="http://127.0.0.1:8000/readLeaveDetails">VN Leave</a>.
                            <br><br>
