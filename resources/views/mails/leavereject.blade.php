                    ...
                    <tr>
                        <td class="innerpadding borderbottom">
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                    <td class="h2">
                                        Leave Approval For {{ $rejected['title'] }}
                                    </td>
                                </tr>
                                <tr>
                                    <td class="bodycopy">
                                        We thank our staff who have worked at Venture Nucleus.<br>
                                        As we know you have applied for a leave on {{ $rejected['apply_date'] }}, 
                                        and thus, we would like to inform that your leave has been <b style="color: red">REJECTED</b>.<br>
                                        We understand that this is the kind of leave update that you do not wish to hear, 
                                        but the company have to make this decision with big regrets.<br>
                                        Hereby the leave details that you have applied for:
                                    </td>
                                </tr>
                            </table>
                        </td>
