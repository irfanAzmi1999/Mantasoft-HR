                ...
                <table bgcolor="#ffffff" class="content" align="center" cellpadding="0" cellspacing="0" border="0">
                    ...
                    <tr>
                        <td class="innerpadding borderbottom">
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                ...
                                <tr>
                                    <td class="bodycopy">
                                        Dear Mr/Mrs. {{ $details['superior'] }},<br><br>
                                        We would like to inform that one of your staff, {{ $details['staff'] }}, 
                                        have applied for a new leave application. 
                                        Hereby the leave details for {{ $details['staff'] }}:
                                    </td>
                                </tr>
                            </table>
                        </td>
                    ...
                    <tr>
                        <td class="innerpadding bodycopy">
                            Kindly update the leave application at <a href="http://127.0.0.1:8000/leaveApproval">VN Leave</a>.
                            <br><br>
