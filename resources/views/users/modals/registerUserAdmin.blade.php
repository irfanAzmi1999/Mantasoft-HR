				...
				<div class="form-group manage">
					...
					<div class="row">
						<div class="col-md-6 mb-1">
							...
							<select class="form-control form-select select2" id="superior_id" name="superior_id" required autofocus>
							...
							<strong id="superiorError" class="col-form-label text-danger">Select a superior.</strong>
						</div>
						<div class="col-md-6 mb-1">
							...
							<strong id="usernameError" class="col-form-label text-danger">Fill in the username.</strong>
							<div id="print"></div>
						</div>
					</div>
					<div class="row">
