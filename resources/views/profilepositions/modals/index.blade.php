        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group manage">
                    ...
                    <label for="position_id" style="margin-bottom: 0.25em"><strong>Position</strong></label>
                    <select class="form-control form-select select2" id="position_id" name="position_id" required autofocus>
                        <option value="" disabled="disabled" selected="selected">Select position...</option>
                        @foreach($byDepartment as $department)
                            @if(count($department->getPosition) > 0)
                                <optgroup label="{{ $department->name }}">
                                    @foreach($department->getPosition as $p)
                    ...
                    <strong id="positionError" class="col-form-label text-danger">Select a position.</strong>
                </div>
...
<input type="hidden" name="profileposition_id" id="profileposition_id" value="">