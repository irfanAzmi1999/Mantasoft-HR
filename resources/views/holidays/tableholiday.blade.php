...
@section('content')
    ...
    <div class="table-title">
        <div class="row">
            ...
            <div class="col-sm-4">
                <button id="newHoliday" class="btn btn-info add-new float-end" style="text-decoration: none; color: white;">
    ...
    <div class="table-responsive">
        <table class="table-holidays table">
            <thead>
                <tr>
                    <th>No.</th>
                    <th>Name</th>
...
@section('extraJS')
    ...
    <script src={{ asset('custom_js/holiday.js') }}></script>
@endsection