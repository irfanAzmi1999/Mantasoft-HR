...
@section('content')
    ...
    <div class="table-title">
        <div class="row">
            ...
            <div class="col-sm-4">
                <button id="newEmergencyType" class="btn btn-info add-new float-end" style="text-decoration: none; color: white;">
    ...
    <div class="table-responsive">
        <table class="table-emergencyType table">
            <thead>
                <tr>
                    <th>No.</th>
