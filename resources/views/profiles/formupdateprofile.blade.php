        ...
        <div class="card mt-3">
            <div class="card">
                ...
                <div class="card-body py-2 my-25">
                    <div class="d-flex">
                        <form class="pt-50" action="/updateallProfile" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="row mt-2">
                                ...
                                <div class="col-12 col-sm-6 mb-1">
                                    ...
                                    <select name="role_id" class="form-control form-select select2" required>
                                ...
                                <div class="col-12 col-sm-6 mb-1">
                                    ...
                                    <select name="department_id" class="form-control form-select select2" required>
                                ...
                                <div class="col-12 col-sm-6 mb-1">
                                    ...
                                    @if($s->superior_id != null)
                                        <select name="superior_id" class="form-control form-select select2" required>
                                            <option value="" disabled="disabled" >Select superior...</option>
                                            @foreach($superior as $su)
                                                @if($su->user_id == $s->superior_id)
                                                    <option selected value="{{ $su->user_id }}">{{ $su->getUser->name }}</option>
                                                @else
                                                    <option value="{{ $su->user_id }}">{{ $su->getUser->name }}</option>
                                                @endif
                                            @endforeach
                                        </select>
                                    @else
                                        <input type="text" name="superior" class="form-control" value="{{ $s->getSuperior->name ?? '' }}" placeholder="Superior" readonly>
                                    @endif
                                </div>
                                <div class="col-12 col-sm-6 mb-1">
                                    <label class="form-label">Employment Date</label>
                                    <input type="text" name="employ_date" class="bg-white form-control flatpickr-basic" value="{{ date('d-m-Y', strtotime($s->employ_date)) }}" placeholder="Employment Date (D-M-Y)">
                                </div>
                                @endforeach
                            </div>
