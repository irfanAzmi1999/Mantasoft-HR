...
$(window).on('load', function () {
  ...
  var $earningsStrokeColor3 = '#ffa0a0';
  ...
  //     'You have successfully logged in to VN leave V2. Now you can start to create, update and delete an data!',
  //     '👋 Welcome',
  //     {
  //       closeButton: true,
  //       tapToDismiss: false,
  ...
  earningsChartOptions = {
    ...
    series: [leaveBalance, taken],
    legend: { show: false },
    comparedResult: [2, -3, 8],
    labels: ['Balance', 'Taken'],
    stroke: { width: 0 },
